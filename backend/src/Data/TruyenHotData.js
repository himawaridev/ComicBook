...
// Hàm crawl dữ liệu
const CrawlTruyenHot = async () => {
    const TruyenHotData = []; // Tạo mảng rỗng để chứa dữ liệu
    ...
    // Kiểm tra kết quả
    if (TruyenHotData.length === 0) {
        console.error("[❌ No data] Check the URL structure: Data/TruyenHotData.js");
        return [];
    }

    // UnLock this line to see the data:
    // console.log("[TruyenHotData.js]", TruyenHotData);

    return TruyenHotData;
};
