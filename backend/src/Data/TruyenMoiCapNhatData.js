...
// Khai báo URL
const nameType = 'truyen-moi-cap-nhat';
...
// Hàm crawl dữ liệu
const CrawlTruyenMoiCapNhat = async () => {
    const TruyenMoiCapNhatData = []; // Tạo mảng rỗng để chứa dữ liệu
    ...
    // Kiểm tra kết quả
    if (TruyenMoiCapNhatData.length === 0) {
        console.error("[❌ No data] Check the URL structure: Data/TruyenMoiCapNhatData.js");
        return [];
    }

    // UnLock this line to see the data:
    // console.log("[TruyenMoiCapNhatData.js]", TruyenMoiCapNhatData);

    return TruyenMoiCapNhatData;
};
