...
module.exports = (sequelize) => {
    ...
    class TruyenKiemHiep extends Model {
        // Khai báo class `TruyenKiemHiep` kế thừa từ Sequelize `Model`.
    ...
    TruyenKiemHiep.init(
        ...
        {
            sequelize,
            modelName: "TruyenKiemHiep",
            freezeTableName: true,
            tableName: "TruyenKiemHiep",
            timestamps: true,
        }
    );

    return TruyenKiemHiep;
}
